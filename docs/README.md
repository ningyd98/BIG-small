...
- [Runtime Architecture](simulation_runtime_architecture.md): Phase 11.1 异步任务编排。
- [Job State Machine](simulation_job_state_machine.md): 持久状态机和合法转换。
- [Runtime Persistence](simulation_runtime_persistence.md): SQLite schema、迁移和脚本。
- [Workers And Leases](simulation_worker_and_leases.md): worker、租约和并发策略。
- [Cancellation And Timeout](simulation_cancellation_and_timeout.md): cancel 与 timeout 语义。
- [Runtime Recovery](simulation_runtime_recovery.md): 重启恢复和 artifact recovery。
- [Phase 12 研究问题](thesis_research_questions.md): RQ1-RQ7。
- [Phase 12 统计方法](phase12_statistical_method.md): CI、effect size 和 paired difference。
- [Phase 12 验收](phase12_acceptance.md): smoke、validation、full 和最终封板状态。
...
- [Phase 11.1 设计](phase11_1_design.md)
- [Phase 11.1 验收](phase11_1_acceptance.md)
- [Phase 11.1 报告](phase11_1_report.md)
- [MuJoCo Runtime Acceptance](mujoco_runtime_acceptance.md)
- [Phase 12 设计](phase12_design.md)
- [Phase 12 报告](phase12_report.md)
