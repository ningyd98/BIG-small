...
| Phase 12 Final Evaluation | 新增 smoke/validation/full 管线 | `scripts/verify_phase12.py --smoke|--validation|--full` | `artifacts/phase12` | smoke 可 CI；full 需资源 | 不涉及硬件 |
...
Phase 12 冻结 RQ1-RQ7 和 F01-F20，输出最终实验、统计、图表、表格、论文素材和答辩包。Smoke 只声明 `PHASE12_EXPERIMENT_SUITE_READY`，不能替代 full final accepted。
