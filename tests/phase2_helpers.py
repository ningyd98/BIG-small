...
def contract(
    *,
    task_id: str = "task-phase2-pick-place",
    plan_version: int = 1,
    command_seq: int = 1,
    ...
    return TaskContract(
        ...
        steps=steps
        or [
            step("step-home", SkillName.HOME, success_conditions=["robot_in_safe_pose"]),
            step(
                "step-move-above",
            ...
            step("step-release", SkillName.RELEASE, success_conditions=["gripper_open"]),
            step("step-retreat", SkillName.RETREAT, parameters={"distance_m": 0.1}),
            step("step-home-final", SkillName.HOME, success_conditions=["robot_in_safe_pose"]),
        ],
